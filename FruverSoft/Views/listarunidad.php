...
<html lang="es">
  ...
  <header>
      ...
      <?php #php de tablas productos
          ...
          $consulta = "SELECT uniId, uniDenominacion, uniAbreviatura, uniObservaciones
          FROM tblunidadmedidas 
          ORDER BY uniId;";
    ...
    <section class="tabla_productos">
      <h1 class="stilepro" style="background-color:#343a40">Medidas - Productos</h1>
      &nbsp;
      <a href="unidad.php">
