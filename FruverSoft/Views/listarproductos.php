...
<html lang="es">
  ...
  <header>
      ...
      <?php #php de tablas productos
          ...
          $consulta = "SELECT proId, proNombre, proVencimiento, prodPrecio, tblclasificaciones_claId,
          tblunidadmedidas_uniId, tblproveedores_proId
          FROM tblproductos 
          ORDER BY tblproductos.proId;";
    ...
    <section class="tabla_productos">
      <h1 class="stilepro" style="background-color:#343a40">Productos</h1>
      &nbsp;
