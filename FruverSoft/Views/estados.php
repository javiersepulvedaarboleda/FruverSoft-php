...
<html lang="es">
  ...
  <header>
        ...
        &nbsp;
        <h1 class="stilepro">Estados - Usuarios - Proveedores</h1>
          ...
          <div class="col-md-4">
              <form method="POST" action="estados.php" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="estId" class="form-control" id="estId" placeholder="Ingrese El Id">
                </div>

                <div class="form-group">
                    <label for="descripcion">Descripcion</label>
                    <input type="text" name="estDescripcion" class="form-control" id="estDescripcion" placeholder="Ingrese La Descripcion">
                </div>
        ...
        <?php
           ...
           $conexion = mysqli_connect ($host, $usuario, $pass, $nombre);
              ...
              {                
                  $estId=$_POST['estId'];
                  $estDescripcion=$_POST['estDescripcion'];
                  ...
                  } else
                  {
                    ...
                    $resultados = mysqli_query($conexion,"SELECT * FROM $basededatos.$tabla_estados WHERE estId = '$estId'"  );
                    ...
                    {
                      echo "<script>
                      alert('el estado ya existe en la base de datos');
                      </script>";
                      
                    }else 
                    {
                      // registro de datos en la bd
                      mysqli_query($conexion, "INSERT INTO $basededatos.$tabla_estados (estId,
                      estDescripcion)
                      values 
                      ('$estId','$estDescripcion')");
                      echo "<script>
                      alert('el estado  fue registrado');
                      </script>";           
                    }
                  }  
                ...
                if(isset($_POST['btn_consultar']))
                {
                  ...
                  }else
                  {
                    ...
                    while($consulta = mysqli_fetch_array($resultados))
                    {
                    echo $consulta['estId']."<br>";
                    echo $consulta['estDescripcion']."<br>";


                    $existe++;
                    }  
                    if($existe ==0){echo "<script> alert('El estado no existe en la base de datos');</script>";}                    
                  }
             ...
             if(isset($_POST['btn_actualizar']))
             {
              ...
              $estDescripcion=$_POST['estDescripcion'];
                     ...
                     else 
                   {
                     ...
                     else
                     {
                       ...
                       $_UPDATE_SQL="UPDATE $basededatos.$tabla_estados Set 
                           estId='$estId',
              ...
              if(isset($_POST['btn_eliminar']))
              {
                ...
                }else
                {
                  ...
                  { 
                    echo "<script>
                    alert('El estado no existe  en la base de datos');
                    </script>";
                  }   
                  else 
                  {
                    $_DELETE_SQL =  "DELETE FROM $tabla_estados WHERE estId = '$estId'";
                    mysqli_query($conexion,$_DELETE_SQL); 
                    echo "<script>
                    alert('El estado fue  eliminado de la base de datos');
                    </script>";
                  }       
                }
                mysqli_close($conexion); 
