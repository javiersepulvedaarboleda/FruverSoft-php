...
<html lang="es">
  ...
  <header>
      ...
      <?php #php de tablas productos
          ...
          $consulta = "SELECT proId, proNombre, proDireccion, proTelefono, proCorreo, tblestados_estId
          FROM tblproveedores 
          ORDER BY proId;";
    ...
    <section class="tabla_productos">
      <h1 class="stilepro" style="background-color:#343a40">Proveedores - Usuarios</h1>
      &nbsp;
